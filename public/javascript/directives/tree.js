 ...
 * 
 * Note: do not perform syntax checking. This directive works properly and should 
 * be excluded from the Gulp JSLint goal and tests. It works. Don't break it.
 */
texasfossils.directive('tree', [
  '$timeout',
  function ($timeout) {
    return {
      restrict: 'E',
